...
public class ExtractModules4OntologyEntities {
    ...
    private String resultModuleFilePath = "/tmp/";

    private List<String> fileNames = new ArrayList<String>(Arrays.asList(
                "basic.owl", "chebi_import.owl", "cl-basic.owl",
                "cl-bridge-to-fbbt.owl", "cl-bridge-to-fma.owl",
                "cl-bridge-to-ma.owl", "cl-bridge-to-wbbt.owl",
                "cl-bridge-to-zfa.owl", "cl_import.owl",
                ...
                "go_import.owl", "go_phenotype.owl", "hp-importer.owl",
                "hp.owl", "hsapdv_import.owl", "human-genes.owl", "mammal.owl",
                "merged.owl", "metazoa.owl", "monarch.owl", "mp-edit.owl",
                "mp-importer.owl", "mp.owl", "mp_hp-align-equiv.owl",
                "mpath_import.owl", "mpath_phenotype.owl", "nbo_import.owl",
                "nbo_phenotype.owl", "ncbitaxon_import.owl", "pato.owl",
                "pato_import.owl", "po_import.owl", "pr_import.owl",
                "ro_extra.owl", "ro_import.owl", "ro_pending.owl", "so.owl",
                "so_import.owl", "uberon-bridge-to-fbbt.owl",
                "uberon-bridge-to-fma.owl", "uberon-bridge-to-ma.owl",
                "uberon-bridge-to-nifstd.owl", "uberon-bridge-to-wbbt.owl",
                "uberon-bridge-to-zfa.owl", "uberon_import.owl",
                "uberon_phenotype.owl", "vertebrate-curated.owl", "vertebrate.owl",
                "wbbt_import.owl", "wbphenotype-equivalence-axioms-subq-ubr.owl",
                "wbphenotype-importer.owl", "wbphenotype.owl", "x-disjoint.owl",
                "zfa.owl", "zp-importer.owl", "zp.owl"
            ));
